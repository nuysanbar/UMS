    ...
    return (
        <div>
            <div style={{display:"inline-block",width:"400px"}}>
              <img src={`http://localhost:3500/${response.imgUrl}`} alt="profile pic" style={{width:"400px",height:"300px",height:"500px",marginTop:"30px",borderRadius:"20px"}} />
            </div>
            ...
            <div style={{width:"700px",margin:"0 auto"}}>
              ...
              {suspended &&<Button variant='outlined' style={{color:"red",borderColor:"var(--bl)"}} onClick={()=>toggleSuspend(response.username,suspended,setSuspended)}>activate account</Button>}
              {!suspended &&<Button variant='contained'style={{backgroundColor:"var(--bl)"}}  onClick={()=>toggleSuspend(response.username,suspended,setSuspended)}>Deactivate account</Button>}
